...
class Product(models.Model):
   ...
   item_count = models.FloatField(default=1.0)
   name = models.CharField(max_length=200, default="")
   tax_rate_nonedible = models.BooleanField(default=False)
   ...
   qr_code = models.CharField(max_length=50,default="unknown")
   spanish_name = models.CharField(max_length=200,default="unset spanish")
   upc_code = models.BigIntegerField(default="0")
